...
public class DPCNCalendar extends DPCalendar {
    ...
    private static final String[][] FESTIVAL_G = {
            {"元旦","除夕"},
            {"气象节","元宵节","情人节"},
            {"爱耳日", "妇女节", "保护母亲河日", "植树节", "国际警察日", "消费者权益日", "气象日"},
            {"愚人节", "清明节", "地球日"},
            {"劳动节", "青年节", "护士节", "国际家庭日","中国旅游日",  "世界无烟日"},
            {"儿童节", "爱眼日", "国际奥林匹克日", "国际禁毒日"},
            {"建党节", "中国抗战纪念日", "世界人口日"},
            {"建军节", "国际青年节"},
            {"抗战胜利日", "教师节", "爱牙日"},
            {"国庆节", "世界动物日", "粮食日", "万圣节"},
            {"记者节", "世界糖尿病日", "大学生节"},
            {"爱滋病日", "人权日","南京大屠杀", "澳门回归","平安夜","圣诞节"}};

    private static final int[][] FESTIVAL_G_DATE = {
            {1,27},         //1月
            {10,11,14},     //2月
            {3, 8, 9, 12, 14, 15, 23},  //3月
            {1, 4, 22},      //4月
            {1, 4, 12, 15, 19, 31},   //5月
            {1, 6, 23, 26},      //6月
            {1, 7, 11},         //7月
    ...
    public String getFestivalG(int month, int day) {
        String tmp = "";

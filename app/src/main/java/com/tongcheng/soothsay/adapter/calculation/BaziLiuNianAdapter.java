...
public class BaziLiuNianAdapter extends BaseAdapter {
    ...
    public BaziLiuNianAdapter(Context context, List<BaziPaipanBean.LiuNianBean> datas, int headItemlayout, int itemslayout) {

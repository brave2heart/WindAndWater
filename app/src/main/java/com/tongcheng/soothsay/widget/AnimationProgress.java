...
public class AnimationProgress extends View {
    ...
    private final int TIME_INTERVAL = 15;  //重绘时间间隔
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mRectF==null)
            mRectF = new RectF(getPaddingLeft(), getPaddingTop(), currRatio + getPaddingRight(), viewHeight + getPaddingBottom());
        mRectF.set(getPaddingLeft(),getPaddingTop(),currRatio+getPaddingRight(),viewHeight+getPaddingBottom());

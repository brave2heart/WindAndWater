...
public class CircularProgress extends View {
    ...
    private void init(AttributeSet attrs){
        ...
        if(a != null){
            ...
            circularColor = a.getColor(R.styleable.CircularProgress_circularColor,Color.parseColor("#ffffff"));
            alphaColor = a.getColor(R.styleable.CircularProgress_alphaColor,Color.parseColor("#ffffff"));
            a.recycle();
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(fen,viewWidth/2 + TEXT_INTERVAL * 2,viewHeight / 2 + textHeight / 2 - 18,textPaint);

...
public class WeatherLineChart extends View {
    ...
    //存储Max轴的数据
    private List<Integer> YValueMax = new ArrayList<>();
    //存储Min轴的数据
    private List<Integer> YValueMin = new ArrayList<>();
    //控件的高度
    ...
    public List<Integer> getYValueMin() {
        return YValueMin;
    }

    public void setYValueMin(List<Integer> YValueMin) {
        this.YValueMin = YValueMin;
    }

    public List<Integer> getYValueMax() {
        return YValueMax;
    }

    public void setYValueMax(List<Integer> YValueMax) {
...
//            float partVlaue=yAxisHeight/parts;
    ...
    //画线
    public void DrawLine(Canvas canvas, List<Float> XValue, List<Float> mYAxis, List<Integer> YValue, boolean top) {

...
//                addIconTab(i, ((IconTabProvider) pager.getAdapter()).getPageIconResId(i));
                addIconToTetxtViewTab(i, ((IconTabProvider) pager.getAdapter()).getPageIconResId(i),pager.getAdapter().getPageTitle(i).toString());
            } else {
...
//                pageListener.onPageSelected(0);
    ...
    //给tab添加icon
    private void addIconToTetxtViewTab(final int position, int resId,String text){
        ...
        tab.setGravity(Gravity.CENTER);
        tab.setSingleLine();
        tab.setCompoundDrawablePadding(5);
        tab.setCompoundDrawables(d,null,null,null);

 ...
 */
public class LoginAlertDialog implements View.OnClickListener {
...
//    private final ImageView mBack;
    ...
    public LoginAlertDialog(Builder builder) {

        mBuilder = builder;
        mDialog = new Dialog(mContext, com.wevey.selector.dialog.R.style.MyDialogStyle);
        mDialogView = View.inflate(mContext, R.layout.login_alert_dialog, null);
...
//        mBack = (ImageView) mDialogView.findViewById(R.id.md_dialog_back);
...
//        if (i==R.id.md_dialog_back&&mBuilder.getListener()!=null){
//            mBuilder.getListener().clickLeftButton(mBack);
//            return;
//        }
    ...
    public static class Builder {
        ...
        public boolean getIsOneButton(){
            return TextUtils.isEmpty(this.getLeftButtonText());

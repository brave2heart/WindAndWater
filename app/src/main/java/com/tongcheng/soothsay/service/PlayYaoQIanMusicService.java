...
public class PlayYaoQIanMusicService extends Service {
    ...
    public class MyBinder extends Binder {
       public PlayYaoQIanMusicService getService() {
            return PlayYaoQIanMusicService.this;
        }
    }
    ...
    public void onCreate() {
        ...
        mp = MediaPlayer.create(PlayYaoQIanMusicService.this, R.raw.lingji_yaoqian);
    }

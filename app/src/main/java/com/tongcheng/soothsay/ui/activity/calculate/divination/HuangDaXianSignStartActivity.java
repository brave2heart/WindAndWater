...
public class HuangDaXianSignStartActivity extends BaseTitleActivity {
    ...
    private HuangDaXianBean mHuangDaXianBean;
    ...
    private ServiceConnection conn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mService.setMusic(HuangDaXianSignStartActivity.this, R.raw.lingji_yaoqian);
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLlBg.setBackgroundResource(R.drawable.qqws_hdx_bg);
        initListener();
        initData();
...
//        这里跳到别的地方
        ...
        map.put("position", String.valueOf(mHuangDaXianBean.getPosition()));
        GotoUtil.GoToActivityWithData(this, HuangDaXianJieQianActivity.class, map);
    }
...
//                这里做缩放动画
        ...
        mTranslationX.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                mHuangDaXianBean = new HuangDaXianBean(i);
                mQian.setText(mHuangDaXianBean.getdijiqian());
            }
        });

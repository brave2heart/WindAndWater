...
public class BenMingMarriageActivity extends BaseTitleActivity implements TimePickerView.OnTimeSelectListener {
    ...
    public void initView() {
        super.initView();
        getBaseHeadView().showTitle(getResources().getString(R.string.title_ben_ming));
            ...
            MarriageLoveApi.getInstance().getMarriageLove(data).
                    enqueue(new ApiCallBack<ApiResponseBean<HeHun>>(new BaseCallBack() {
                        ...
                        public void onSuccess(Object data) {
                            ...
                            if (bean != null){
                                GotoUtil.GoToActivityWithBean(BenMingMarriageActivity.this,TestBenMingActivity.class,bean);
                            }
                        ...
                        public void onError(String errorCode, String message) {
                            getBaseLoadingView().hideLoading();
                            boolean b = ErrorCodeUtil.shownetWorkAndServerError(BenMingMarriageActivity.this, errorCode);
                            if (b == false){
                                ToastUtil.showShort(BenMingMarriageActivity.this,message);
                            }
                        }
                    }));

...
public class MazuSignStartActivity extends BaseTitleActivity {
    ...
    private ServiceConnection conn = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            mService.setMusic(MazuSignStartActivity.this, R.raw.lingji_yaoqian);
        }
...
//        这里跳到别的地方
        ...
        map.put("position", String.valueOf(mMaZuBean.getPosition()));
        GotoUtil.GoToActivityWithData(this, MazuJieQianActivity.class, map);
    }
...
//                这里做缩放动画
        ...
        mTranslationX.addListener(new AnimatorListenerAdapter() {
            ...
            @Override
            public void onAnimationEnd(Animator animation) {
                int i = mRandom.nextInt(59);
                mMaZuBean = new MaZuBean(i);
                mQian.setText(mMaZuBean.getdiJiQian());
            }
        });

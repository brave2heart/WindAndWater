            ...
            if (info != null) {
                ...
                if (NetworkInfo.State.CONNECTED == info.getState() && info.isAvailable()) {
                    if (info.getType() == ConnectivityManager.TYPE_WIFI
                        ...
                        EventBusUtil.post(new EventNetWorkChangeBean(EventNetWorkChangeBean.NETWORK_CONNECTED));
                    }
                } else {
                    Log.i("TAG", getConnectionType(info.getType()) + "断开");
                    EventBusUtil.post(new EventNetWorkChangeBean(EventNetWorkChangeBean.NETWORK_UNCONNECTE));
                }
            }
        }
    }

...
public abstract class BasePopupWindow implements PopupWindow.OnDismissListener, Animation.AnimationListener {
    ...
    public BasePopupWindow(Activity activity, int resId,boolean outSide){
        ...
        pWindow = new PopupWindow(parentView, WindowManager.LayoutParams.MATCH_PARENT, WindowManager.LayoutParams.MATCH_PARENT, true);
        pWindow.setFocusable(true);
        pWindow.setBackgroundDrawable(activity.getResources().getDrawable(android.R.color.transparent));

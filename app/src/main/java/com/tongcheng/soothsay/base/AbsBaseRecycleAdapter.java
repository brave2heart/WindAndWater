 ...
 * 可以添加多个透视图、尾视图的适配器
 * 只需重写简单方法即可
 * 需要 BaseRecycleViewHolder 配合
 */
public abstract class AbsBaseRecycleAdapter<T> extends RecyclerView.Adapter<AbsBaseRecycleViewHolder> {
     ...
     * @param itemLayoutId
     */
    public AbsBaseRecycleAdapter(Context context, List<T> mDatas, int itemLayoutId) {
    ...
    private void onBindAdvanceViewHolder(AbsBaseRecycleViewHolder holder, int i) {
        bindData(holder, mDatas.get(i));
    }
     ...
     * @param t      每一Item显示的数据
     */
    public abstract void bindData(AbsBaseRecycleViewHolder holder, T t);
     ...
     * @return Holder对象
     */
    protected AbsBaseRecycleViewHolder onCreateAdvanceViewHolder(ViewGroup parent, int viewType) {

        View v = mInflater.inflate(mItemLayoutId, parent, false);
        return new AbsBaseRecycleViewHolder(v, this);
    }

    @Override
    public AbsBaseRecycleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(AbsBaseRecycleViewHolder holder, int position) {
    ...
    class HeaderHolder extends AbsBaseRecycleViewHolder {
    ...
    class FooterHolder extends AbsBaseRecycleViewHolder {

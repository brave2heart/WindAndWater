...
import com.living.ui.activity.GongXiuHopeDetailsActivity;
import com.living.ui.activity.GongXiuLifeDetailsActivity;
            ...
            if (type == 1) {
                mItemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(v.getContext(), GongXiuLifeDetailsActivity.class);

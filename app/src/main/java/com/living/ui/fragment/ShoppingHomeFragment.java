...
//    }
    ...
    public View initView(LayoutInflater inflater, ViewGroup container) {
        View view = inflater.inflate(R.layout.acitivity_shopping_home, container, false);
        return view;
    }
...
//
//                ShoppingHomeFragment.this.finish();
//            }
//        });
    ...
    public void setAdvertise(final List<ShopHomeBean.AdsBean> advertise) {
        ...
        mBannerView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                GotoUtil.GoToWebViewActivity(getActivity(),
    ...
    private void initHeadRecycleView() {
        ...
        ShopHomeHeadRecyleViewAdapter recycleAdapter = new ShopHomeHeadRecyleViewAdapter(getActivity(), list,
                R.layout.item_shop_head_recyclerview);
        rvShopHead.setLayoutManager(new GridLayoutManager(getActivity(), 4));
...
//                        }
    ...
    private void initContentRecycleView(List<ShopHomeBean.StoreInfosBean> storeInfos) {
        adapter = new ShopHomeInfoRecyclerViewAdapter(getActivity(), getContext(), storeInfos,

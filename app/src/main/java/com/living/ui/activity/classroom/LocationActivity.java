package com.living.ui.activity.classroom;
...
import com.living.adapter.AddressAdapter;
import com.living.utils.DataConversionUtils;
import com.living.utils.DatasKey;
import com.living.utils.OnItemClickLisenter;
import com.living.utils.SHA1;
import com.living.utils.SPUtils;
...
//                            Toast.makeText(LocationActivity.this, "发送：" + poiItem.getTitle() + "  " + poiItem.getSnippet() + "  " + "纬度：" + poiItem.getLatLonPoint().getLatitude() + "  " + "经度：" + poiItem.getLatLonPoint().getLongitude(), Toast.LENGTH_SHORT).show();
                            ...
                            intent.putExtra("location_return", poiItem.getTitle());

...
public class GongXiuHopeActivity extends BaseTitleActivity implements ImageWatcher.OnPictureLongPressListener, MessagePicturesLayout.Callback {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.headBackButton:
                GongXiuHopeActivity.this.finish();
                break;
            case R.id.headShareButton:
                new UMShareUtils(GongXiuHopeActivity.this).shareDefault(R.mipmap.ic_launcher, "生活感悟", "生活感悟", "www.baidu.com ");
                break;
            case R.id.fab:
